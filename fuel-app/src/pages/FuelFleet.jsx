...
function FuelMyFleet() {
    ...
    return (
        <div className="container fuel-page py-4">
            <div className="card shadow-sm page-surface">
                <div className="card-body">
                    <h2 className="card-title">Fuel My Fleet 🚚</h2>
                    <p className="card-text">Subscribe for regular fueling for all your company vehicles.</p>
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button className="btn btn-outline-secondary" onClick={() => { setFuelType(""); setLiters(""); setPrice(0); setMessage(""); }}>Reset</button>
                    </div>
